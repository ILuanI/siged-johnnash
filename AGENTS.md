...
- `README.md` explica el framework a las personas. No es el contrato operativo.
- `AGENTS.md` define el comportamiento comun de los agentes y funciona como
  router de lectura.
- `docs/spec/` describe el comportamiento vigente del producto.
...
Las reglas de negocio viven en `docs/spec/`. Los documentos de modulo y flujo
orientan, pero no sustituyen la verificacion contra el codigo real.
