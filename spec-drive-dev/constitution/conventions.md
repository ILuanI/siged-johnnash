**EJEMPLO TOMADO DE OTRO PROYECTO**
...
|---|---|---|
| `spec-drive-dev/features/NNN/tasks.md` | ✅ Agente marca `[x]` al completar | Al inicio (definir tareas) |
| `spec-drive-dev/constitution/PROGRESS.md` | ✅ Puede actualizarse al cerrar features | Ocasional |
...
| `spec-drive-dev/features/NNN/spec.md` | Parcial (borrador IA) | ✅ Siempre |
| `spec-drive-dev/features/NNN/plan.md` | Parcial (borrador IA) | ✅ Siempre |
| `docs/requirements/*.md` | borrador IA si se pide | ✅ Siempre |
| `spec-drive-dev/constitution/mission.md` | borrador IA si se pide al inicio del proyecto | ✅ |
| `spec-drive-dev/constitution/tech-stack.md` | borrador IA si se pide al inicio del proyecto | ✅ |
| `spec-drive-dev/constitution/roadmap.md` | borrador IA si se pide al inicio del proyecto | ✅ |
...
|---|---|---|
| `docs/requirements/` | `stateDiagram`, `flowchart` (decisión) | El diagrama **es** la regla de negocio (ciclo de vida de una entidad, lógica con 3+ condiciones combinadas) |
...
usar `prototypes/` en la raíz del proyecto, hermana de `docs/` y `spec-drive-dev/`. No va
dentro de `spec-drive-dev/features/` ni de `docs/`: no es proceso versionado de una feature
ni documentación del sistema real. Cada subcarpeta de prototipo debe incluir un
README de una línea indicando a qué feature de `spec-drive-dev/` corresponde y que es
