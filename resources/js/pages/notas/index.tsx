                ...
                <div className="rounded-xl border bg-white shadow-sm overflow-hidden">
                    {examenes.length === 0 ? (
                        <div className="p-12 text-center">
                            <p className="text-slate-600">No hay evaluaciones registradas en el sistema.</p>
                            <Link href="/notas/cargar" className="mt-4 inline-flex">
                        ...
                        <Table>
                            <TableHeader>
                                <TableRow className="bg-slate-50">
                                    ...
                                    <TableHead className="w-[200px]">Ciclo</TableHead>
                                    <TableHead>Métricas por Área (Máx / Mín)</TableHead>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
                                {examenes.map((examen) => (
                                    <TableRow key={examen.id_examen} className="hover:bg-slate-50/50">
                                        ...
                                        <TableCell>
                                            <p className="text-slate-900 font-medium">{examen.descripcion || 'Sin descripción'}</p>
                                        </TableCell>
                                        ...
                                        <TableCell>
                                            <div className="flex flex-wrap gap-3">
                                                {examen.metricas && examen.metricas.length > 0 ? (
                                                    ...
                                                    <span className="text-xs text-slate-400">Sin métricas registradas</span>
                                                )}
                                            </div>
                                        </TableCell>
                                    </TableRow>
